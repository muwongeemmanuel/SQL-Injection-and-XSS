...
<!-- muwonge -->
	<div class="container" style="background-color:skyblue; background: rgba(0, 0, 0, 0.5);padding: 20px;text-align: justify;margin-top: 40px;">
		...
		<div class="row text-white">
			...
			<div class="col-lg-6">
				<br><br>
				<h1 style="text-align: center;">Hi, This is<br>The page displayed</h1>
				<h4 style="text-align: center;"><i>(After successfully logging in)</i></h4>
				<br><br>
				<p>
					<i><b>Either after Correct Username and Password or  SQL Injection</b></i>
				</p>
